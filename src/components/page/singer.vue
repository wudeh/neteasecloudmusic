<template>
  <div>
    ...
    <van-tab title="华语" name="1">
      <div class="wrapper">
        <van-list
          v-model:loading="cn.loading"
          v-model:error="cn.error"
    ...
    <van-tab title="欧美" name="2">
      <div class="wrapper">
        <van-list
          v-model:loading="en.loading"
          v-model:error="en.error"
          :immediate-check="true"
          :finished="en.finish"
          error-text="请求失败，点击重新加载"
          finished-text="已经到底啦"
    ...
    <van-tab title="韩国" name="3">
      <div class="wrapper">
        <van-list
          v-model:loading="ko.loading"
          v-model:error="ko.error"
          :immediate-check="true"
          :finished="ko.finish"
          error-text="请求失败，点击重新加载"
          finished-text="已经到底啦"
    ...
    <van-tab title="日本" name="4">
      <div class="wrapper">
        <van-list
          v-model:loading="ja.loading"
          v-model:error="ja.error"
          :immediate-check="true"
          :finished="ja.finish"
          error-text="请求失败，点击重新加载"
          finished-text="已经到底啦"
