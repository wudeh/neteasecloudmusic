                  ...
                  <div class="item" v-for="subItem in item.resources" :key="subItem.resourceId" @click="playMusicSingle(subItem)">
                    ...
                    <div class="info">
                      <div class="song_title">
                        ...
                        <div class="song_author" v-for="(author_title, index) in subItem.resourceExtInfo.artists" :key="author_title.id">
                          {{ author_title.name }}
                          <span v-if="index < subItem.resourceExtInfo.artists.length - 1">/</span>
                        </div>
                      </div>
                      <div
                        class="song_subTitle"
                ...
                <div class="swiper_item" v-for="(item, index) in info.HOMEPAGE_BLOCK_NEW_ALBUM_NEW_SONG.arrData[info.HOMEPAGE_BLOCK_NEW_ALBUM_NEW_SONG.index]" :key="index">
                  <div class="item" v-for="subItem in item.resources" :key="subItem.resourceId" @click="new_three(subItem)">
                    ...
                    <div class="info">
                      ...
                      <div class="song_subTitle" :class="{ percent: subItem.uiElement.subTitle.title.indexOf('%') != -1 }" v-if="subItem.uiElement.subTitle">
                  ...
                  <div class="item" @click="playMusicSingle(item.resources[0])">
                    ...
                    <div class="info">
                      <div class="song_title">
                        ...
                        <span style="color: #ccc; margin: 0 2px">-</span>
                        <div class="song_author" v-for="(author_title, index) in item.resources[0].resourceExtInfo.artists" :key="author_title.id">
                          {{ author_title.name }}
                          <span v-if="index < item.resources[0].resourceExtInfo.artists.length - 1">/</span>
                        </div>
                      </div>
                      <div class="song_subTitle" :class="{ percent: item.uiElement.subTitle.title.indexOf('%') != -1 }" v-if="item.uiElement.subTitle">
