...
// 歌手详情
export function getArtistDetail(id: string | number): any {
  return axios.get(`/artist/detail?id=${id}`);
}

// 歌手粉丝
export function getArtistFans(id: string | number): any {
  return axios.get(`/artist/fans?id=${id}&limit=10&offset=0`);
}
